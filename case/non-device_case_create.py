...
case_descr = case_short_descr.split("\n")[0]
...
# if this is a TempGuard email for MSHS, default the contact to BISLW
if "DCS TempGuard" in case_short_descr and company == "Mount Sinai - Network":
    contact = "7d1f91b31bce80d02c2ca7d4bd4bcb9e"
